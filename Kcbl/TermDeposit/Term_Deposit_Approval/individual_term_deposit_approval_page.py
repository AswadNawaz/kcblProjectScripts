...
class IndividualTermDepositApprovalPage(BaseClass):
    def __init__(self):
        ################### Individual Term Deposit Menu Locator ######################

        self.termDeposit_locator = By.XPATH, "//app-menu/ul/li[5]/a"
        self.approval_locator = By.XPATH, "//app-menu/ul/li[5]/ul/li[4]/a"
        self.individual_locator = By.XPATH, "//app-menu/ul/li[5]/ul/li[4]/ul/li[1]/a/span[1]"
        self.business_locator = By.XPATH, "//app-menu/ul/li[5]/ul/li[4]/ul/li[2]/a/span[1]"
        ...
        self.status_locator = By.XPATH, "//table/tbody/tr[1]/td[6]"
        self.workflow_stage_locator = By.XPATH, "//table/tbody/tr[1]/td[7]"
    ...
    def term_deposit_refresh_menu(self):
        self.click(self.business_locator)
        time.sleep(2)
        self.click(self.individual_locator)

    def term_deposit_individual_approval_with_accept(self):
    ...
    def term_deposit_individual_approval_with_reject(self):
    ...
    def term_deposit_individual_approval_with_save(self):
        #################### View List #####################
